...
pipeline {
    ...
    stages {
        ...
        stage('Deploy to Production fixed server') {
            ...
            steps {
                ...
                script {
                    ...
                    sh """
                       aws ec2 reboot-instances --region us-east-1 --instance-ids i-077d7556229b0ce9a 
                    """
                }
            }
        }
        ...
        stage('Deploy to Production') {
            ...
            steps {
                script {
                    PRODUCTION_ALB_LISTENER_ARN="arn:aws:elasticloadbalancing:us-east-1:451561843959:listener/app/production-website/024aa08aee6ccadb/9ceb2d86a069ed5f"
                    sh """
